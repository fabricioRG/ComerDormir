 ...
 * @author fabricio
 */
public class ReporteOpinionesHotel extends javax.swing.JInternalFrame {
    ...
    private void actualizarLista() {
        ...
        if(ManejadorOpinion.getInstance().getOpinionesHotel() != null){
            listaOpinionObser.addAll(ManejadorOpinion.getInstance().getOpinionesHotel());
        }
    }
