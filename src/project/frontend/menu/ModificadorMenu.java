...
public class ModificadorMenu extends javax.swing.JInternalFrame {
    ...
    private void buttonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonModificarActionPerformed
        try {
            ManejadorMenu.getInstance().updateMenu(menuSelec, textFieldNombre.getText().trim(), formattedTextFieldPrecio.getText().trim());
            actualizarLista();
    ...
    private void actualizarLista() {
        ...
        if (ManejadorMenu.getInstance().getMenus() != null) {
            listaMenuObser.addAll(ManejadorMenu.getInstance().getMenus());
        }
        buttonModificar.setEnabled(false);
    }
    ...
    private void filtrarLista() {
        ...
        if (ManejadorMenu.getInstance().getMenuByTipo(tipo) != null) {
            listaMenuObser.addAll(ManejadorMenu.getInstance().getMenuByTipo(tipo));
        }
        buttonModificar.setEnabled(false);
    }
