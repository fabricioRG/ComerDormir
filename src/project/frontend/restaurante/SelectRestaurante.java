 ...
 * @author fabricio
 */
public class SelectRestaurante extends javax.swing.JDialog {

    private List<Restaurante> listaRest = null;
    private ObservableList<Restaurante> listaRestauObser = null;
    private Restaurante restauSeleccionado = null;
    public String path;
     ...
     */
    public SelectRestaurante(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${independiente}"));
        columnBinding.setColumnName("Independiente");
        columnBinding.setColumnClass(Integer.class);
        bindingGroup.addBinding(jTableBinding);
        jTableBinding.bind();org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${restauSeleccionado}"), jTable1, org.jdesktop.beansbinding.BeanProperty.create("selectedElement"));
    ...
    private void actualizarLista() {
        ...
        if(ManejadorRestaurante.getInstance().getRestaurantesByState(1)!= null){
            listaRestauObser.addAll(ManejadorRestaurante.getInstance().getRestaurantesByState(1));
        }
        buttonActualizar1.setEnabled(false);
    }
    ...
    public Restaurante getRestauSeleccionado() {
        return restauSeleccionado;
    }

    public void setRestauSeleccionado(Restaurante restauSeleccionado) {
        this.restauSeleccionado = restauSeleccionado;
    }
