 ...
 * @author fabricio
 */
public class ReporteReservacion extends javax.swing.JInternalFrame {
     ...
     */
    public ReporteReservacion(Hotel hotel) {
        this.hotel = hotel;
        this.listaReser = new LinkedList<>();
        this.listaReservacionObser = ObservableCollections.observableList(listaReser);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reporte de Reservacion");

        jSeparator1.setForeground(new java.awt.Color(254, 254, 254));
        jSeparator1.setPreferredSize(new java.awt.Dimension(50, 5));

        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${listaReservacionObser}");
        ...
        buttonActualizar1.setText("Confirmado");
        ...
        buttonActualizar2.setText("Sin confirmar");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(91, 91, 91)
                                .addComponent(buttonActualizar1, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(30, 30, 30)
                                .addComponent(buttonActualizar, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(26, 26, 26)
                                .addComponent(buttonActualizar2, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void buttonActualizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActualizar1ActionPerformed
        actualizarListaByConfirmacion(1);
    ...
    private void buttonActualizar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActualizar2ActionPerformed
        actualizarListaByConfirmacion(0);
    }//GEN-LAST:event_buttonActualizar2ActionPerformed

    private void actualizarLista() {
        listaReservacionObser.clear();
        if(ManejadorReservacion.getInstance().getReservaciones(hotel.getId()) != null){
            listaReservacionObser.addAll(ManejadorReservacion.getInstance().getReservaciones(hotel.getId()));
        }
    }
    
    private void actualizarListaByConfirmacion(int confi){
        listaReservacionObser.clear();
        if(ManejadorReservacion.getInstance().getReservacionesByConfirmacion(confi, hotel.getId()) != null){
            listaReservacionObser.addAll(ManejadorReservacion.getInstance().getReservacionesByConfirmacion(confi, hotel.getId()));
        }
    }

    public ObservableList<Reservacion> getListaReservacionObser() {
        return listaReservacionObser;
    }

    public void setListaReservacionObser(ObservableList<Reservacion> listaReservacionObser) {
        this.listaReservacionObser = listaReservacionObser;
    }
