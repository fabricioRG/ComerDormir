...
public class ReporteClientes extends javax.swing.JInternalFrame {
    ...
    private void actualizarLista(int opcion) {
        ...
        if (opcion == 1) {
            ...
            if (ManejadorCliente.getInstance().getClienteByDPI(formattedTextFieldDPI.getText().trim()) != null) {
                listaClienteObser.add(ManejadorCliente.getInstance().getClienteByDPI(formattedTextFieldDPI.getText().trim()));
            }
        } else if (opcion == 3) {
            if(ManejadorCliente.getInstance().getClientesByName(jTextFieldNombre.getText()) != null) {
                listaClienteObser.addAll(ManejadorCliente.getInstance().getClientesByName(jTextFieldNombre.getText()));
            }
        }
