...
public class CreadorCliente extends javax.swing.JDialog {
     ...
     */
    public CreadorCliente(java.awt.Frame parent, boolean modal, int dpi) {
        super(parent, modal);
        this.dpi = dpi;
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextFieldDireccion.setBackground(new java.awt.Color(254, 254, 254));
        jTextFieldDireccion.setForeground(new java.awt.Color(237, 71, 71));
        jTextFieldDireccion.setText(" ");
        jTextFieldDireccion.setBorder(javax.swing.BorderFactory.createEmptyBorder(7, 7, 7, 7));
        jTextFieldDireccion.setCaretColor(new java.awt.Color(237, 71, 71));
    ...
    private void buttonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRegistrarActionPerformed
        try {
            ManejadorCliente.getInstance().crearCliente(formattedTextFieldDPI.getText().trim(), jTextFieldNombre.getText().trim(), 
                jTextFieldDireccion.getText().trim(), formattedTextFieldTelefono.getText().trim());
            setEstado(true);
            this.dispose();
        } catch (Exception e) {
