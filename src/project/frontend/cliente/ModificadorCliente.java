...
public class ModificadorCliente extends javax.swing.JInternalFrame {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(buttonModificar, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(43, 43, 43)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void buttonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonModificarActionPerformed
        try {
            ManejadorCliente.getInstance().updateCliente(clienteSelec, jTextFieldNombre1.getText().trim(), textFieldTelefono.getText().trim());
        } catch (Exception e) {
    ...
    private void actualizarLista(int opcion) {
        ...
        if (opcion == 1) {
            ...
            if (ManejadorCliente.getInstance().getClienteByDPI(formattedTextFieldDPI.getText()) != null) {
                listaClienteObser.add(ManejadorCliente.getInstance().getClienteByDPI(formattedTextFieldDPI.getText()));
            }
        } else if (opcion == 3) {
            if(ManejadorCliente.getInstance().getClientesByName(jTextFieldNombre.getText().trim()) != null) {
                listaClienteObser.addAll(ManejadorCliente.getInstance().getClientesByName(jTextFieldNombre.getText().trim()));
            }
        }
        buttonModificar.setEnabled(false);
    }
