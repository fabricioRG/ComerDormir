 ...
 * @author fabricio
 */
public class ModificadorEmpleado2 extends javax.swing.JInternalFrame {
     ...
     */
    public ModificadorEmpleado2(Empleado empleado, Hotel hotel) {
    ...
    private void actualizarListaByEstado(int estado) {
        listaEmpleadoObser.clear();
        if (ManejadorEmpleado.getInstance().getEmpleadosByEstadoAndHotel(estado, hotel.getId()) != null) {
            listaEmpleadoObser.addAll(ManejadorEmpleado.getInstance().getEmpleadosByEstadoAndHotel(estado, hotel.getId()));
        }
        buttonEstado.setEnabled(false);
    }
