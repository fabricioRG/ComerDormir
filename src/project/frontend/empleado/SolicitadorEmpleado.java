...
import comerdormir.frontend.MenuPrincipal;
 ...
 * @author fabricio
 */
public class SolicitadorEmpleado extends javax.swing.JDialog {
     ...
     */
    public SolicitadorEmpleado(java.awt.Frame parent, boolean modal, MenuPrincipal mp) {
        super(parent, modal);
        this.mp = mp;
        this.path = BACKGROUNDD_IMAGE_PARENT_RELATIVE_PATH;
        initComponents();
        this.setTitle("Datos de empleado");
    ...
    private void initComponents() {
        ...
        ingresarUsuario.setForeground(new java.awt.Color(16, 78, 154));
        ...
        fieldPassword.setForeground(new java.awt.Color(16, 78, 154));
        ...
        fieldNombre.setForeground(new java.awt.Color(16, 78, 154));
    ...
    /**
     * Metodo que permite verificar si el usuario existe, asi como verificar si
    ...
    private void ingresarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ingresarUsuarioActionPerformed
        try {
            ManejadorEmpleado.getInstance().showHotelDesktop(fieldNombre.getText().trim(), fieldPassword.getPassword());
            if (mp != null) {
    ...
    private void salirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salirButtonActionPerformed
        int accion = JOptionPane.showConfirmDialog(rootPane, "Deseas salir de \"Comer y Dormir\"", "Salir", JOptionPane.YES_NO_OPTION);
