 ...
 * @author fabricio
 */
public class ReporteEmpleados2 extends javax.swing.JInternalFrame {
     ...
     */
    public ReporteEmpleados2(Hotel hotel) {
        this.hotel = hotel;
    ...
    private void initComponents() {
        ...
        comboBoxTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2. Gerente de Hotel", "3. Encargado de Recepcion", "4. Encargado de restaurante" }));
    ...
    private void filtrarLista() {
        ...
        if(ManejadorEmpleado.getInstance().getEmpleadosByHotelAndTipo(hotel.getId(), Character.toString(tipo.charAt(0))) != null){
