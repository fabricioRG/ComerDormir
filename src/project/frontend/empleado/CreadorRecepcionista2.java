 ...
 * @author fabricio
 */
public class CreadorRecepcionista2 extends javax.swing.JInternalFrame {
     ...
     */
    public CreadorRecepcionista2(Hotel hotel) {
        this.hotel = hotel;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Crear Recepcionista");
    ...
    private void buttonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRegistrarActionPerformed
        try {
            ManejadorEmpleado.getInstance().setGerente(formattedTextFieldDPI.getText().trim(),
                    ...
                    formattedTextFieldSueldo.getText().trim(), jDateChooser.getDate(), hotel, 3, 2);
